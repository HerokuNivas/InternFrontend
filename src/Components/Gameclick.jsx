    ...
    return(
        <div>
            ...
            <p className="box9" onClick={()=>{function9()}}><span style={{fontSize: "80px", marginLeft: "20px", color: boardIs[2][2]==="X"?"#2C8DFF":"#FF4F4F", fontWeight: "bolder"}}>{boardIs[2][2]}</span></p>
                ...
                {winby==="" && (cameIn||current===user)  && <div><Button onClick={submitParent} variant="contained" style={{background: "#F2C94C", marginLeft: "20px", marginTop: (placed || came || error)?"10px":"320px", marginBottom: "20px", paddingLeft: "60px", paddingRight: "60px"}}>Submit!</Button></div>}
                {winby==="" && (!cameIn||current===opponent) && <div><Button variant="contained" style={{background: "#E0E0E0", marginLeft: "20px", marginTop: error?"10px":"320px", marginBottom: "20px", color: "black"}}>Waiting for {opponent}</Button></div>}</div>}

    ...
    return(
        ...
        {!loading && <div>
            ...
            {game.length === 0 && <div>
                ...
                <p className="mainLogin" onClick={()=>{navigate("/newgame")}} style={{marginTop: "-50px"}}><span className="mainLoginText" style={{marginLeft: expandClick?"-36px":"-34px"}}>Create new game</span></p>
                </div>}
